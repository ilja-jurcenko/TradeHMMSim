...
| KAMA  |    10 |   50 |      124.08% |         1.246 |  1.022 | -23.57% |     13 |
...
**Comparison to Benchmark:**
- Return Difference: -6.69%
- Sharpe Difference: +0.243
- Profit Factor Difference: +0.084
...
1. **Best Total Return:** KAMA achieved 124.08%, underperforming the buy-and-hold benchmark by -6.69%
...
5. **Parameter Patterns:** Average optimal short window was 17 and long window was 93

6. **Trading Frequency:** Models averaged 21 trades, with KAMA executing 13 trades

### Recommendations

- **Overall:** Buy-and-hold remains competitive; trend-following requires careful model selection
- **For Maximum Returns:** Use KAMA with parameters (10, 50)
